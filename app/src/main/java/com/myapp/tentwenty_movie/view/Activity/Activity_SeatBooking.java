...
import com.myapp.tentwenty_movie.databinding.ActivitySeatbookingBinding;

import java.util.ArrayList;
import java.util.List;

public class Activity_SeatBooking extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = ActivitySeatbookingBinding.inflate(getLayoutInflater());
